...
This AGENTS.md scopes guidance to `股市预测模型/report`. Parent AGENTS guidance still applies unless this file narrows it for this subtree.
...
### Files
- `variable_dictionary_framework.md`
