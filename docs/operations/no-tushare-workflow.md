...
模板参考：
- [公司画像 Seed 模板](../data/templates/company-profiles-seed-template.md)
...
模板参考：
- [市场环境 Seed 模板](../data/templates/market-environment-seed-template.md)
...
模板参考：
- [公司关系 Seed 模板](../data/templates/company-relations-seed-template.md)
