...
def history_source_choices() -> list[str]:
    return [
        "akshare-news",
        "cninfo-disclosure",
        *[profile.history_source for profile in RAW_HISTORY_SOURCE_PROFILES if profile.history_source != "akshare-news"],
    ]
