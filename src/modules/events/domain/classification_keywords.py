#!/usr/bin/env python3
"""Keyword- and rule-driven mappings for event classification."""
...
INDUSTRY_RULES = {
    "军工": ["军工", "战机", "导弹", "无人机", "军品", "空战", "国防", "航空", "航天", "舰船", "兵装", "雷达", "坦克", "军贸", "军演", "装备", "高超音速", "军工股", "军工板块", "歼", "武装", "军控"],
    "新能源": ["新能源", "储能", "锂电", "光伏", "风电", "电池", "充电桩", "新能源汽车", "锂矿", "碳酸锂", "硅料", "组件", "逆变器", "电网", "输变电", "核电", "氢能", "电车", "电动", "光伏产业链", "碳中和", "碳达峰", "绿电", "清洁能源", "分布式", "光伏设备", "风电设备"],
    "科技": ["科技", "机器人", "芯片", "算力", "AI", "人工智能", "人形机器人", "样机", "半导体", "集成电路", "光刻", "5G", "通信", "物联网", "云计算", "大数据", "软件", "数字化", "智能化", "数字人民币", "大模型", "GPT", "量子", "操作系统", "自动驾驶", "智能驾驶", "工业互联网", "信创", "数据要素", "低空经济"],
    "消费": ["消费", "白酒", "旅游", "零售", "餐饮", "食品", "饮料", "家电", "服装", "医美", "化妆品", "医药", "中药", "生物制品", "免税", "酒店", "航空出行", "电影", "游戏", "啤酒", "乳品", "创新药", "制药", "药房", "药企", "制药业", "药监", "临床", "新药", "房产", "房地产", "地产", "物业", "银行业", "证券", "保险", "银行", "金融", "信贷"],
}
...
SUBTYPE_RULES = {
    ...
    "股权变动": ("股权", "增持", "减持", "回购", "并购", "重组", "定增", "递表", "IPO", "辅导验收", "发行H股", "赴港IPO", "股份冻结", "股份转让", "风险警示", "退市风险警示", "撤销退市风险警示", "摘帽", "摘星", "戴帽", "ST"),
    "诉讼仲裁": ("诉讼", "仲裁", "法院裁定", "处罚", "监管措施"),
    "高管变动": ("聘任", "辞职", "辞任", "财务总监", "董秘", "总裁", "董事长", "高管"),
    "技术标准": ("技术标准", "行业标准", "标准发布"),
    "供需价格": ("价格", "涨价", "降价", "库存", "供需", "资金流向", "资金流入", "资金流出", "资金流入榜", "资金流出榜", "两融余额", "融资余额", "杠杆资金", "股息率", "分红", "成交额突破", "成交额", "净流入", "净流出", "排行榜", "新建仓"),
