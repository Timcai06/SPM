...
CREATE TABLE IF NOT EXISTS event_propagation_links (
    id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_event_propagation_links_event
    ON event_propagation_links (structured_event_id);

CREATE INDEX IF NOT EXISTS idx_event_propagation_links_source
    ON event_propagation_links (source_company_id);

CREATE INDEX IF NOT EXISTS idx_event_propagation_links_target
    ON event_propagation_links (target_company_id);

CREATE INDEX IF NOT EXISTS idx_event_propagation_links_score
    ON event_propagation_links (propagation_score DESC);
